  ...
  render() {
    return (
      <div className="container">
        ...
        <SvgContainer breathe="0.05" fill="#e0ddc0" id="holidays" svg="svg/holidays" classname="holidays res" title="Holidays"></SvgContainer>
        ...
        <SvgContainer delay fill="#d84141" id="zero" svg="svg/zero" classname="zero res number" title="Zero"></SvgContainer>
        <SvgContainer fill="#4c3356" id="one" svg="svg/one" classname="one res number" title="One"></SvgContainer>
        <SvgContainer delay fill="#d84141" id="six" svg="svg/six" classname="six res number" title="Six"></SvgContainer>
